...
def press_calc():
    ...
    create_buttun(window_calc, '00', lambda: ent_input.insert(END, '00')).grid(row=4, column=1, pady=5, padx=5, ipadx=1, ipady=1, sticky=NSEW)
    create_buttun(window_calc, '.', lambda: ent_input.insert(END, '.')).grid(row=4, column=2, pady=5, padx=5, ipadx=1, ipady=1, sticky=NSEW)
